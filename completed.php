...
<body>
    ...
    <main class="table">
        <section class="table_header">
            ...
            <p><a href="upcoming.php">Upcoming</a> </p>
            <p><a href="pbooking.php">Back</a></p>
            </div>
        </section>
        <section class="table_body">
            <?php
                ...
                $doc=1;
                $pay='0';
                $sql="SELECT * FROM consult WHERE puserid='$idp' AND doccon='$doc' AND payment!='$pay'";
            ...
            <table>
                ...
                <?php
                    ...
                    $sql="SELECT * FROM consult WHERE puserid='$idp'";
                    $res=mysqli_query($con, $sql);
                    while($row=mysqli_fetch_assoc($res)) {
                        $dlid=$row['duserid'];
                        $date=$row['opdate'];
